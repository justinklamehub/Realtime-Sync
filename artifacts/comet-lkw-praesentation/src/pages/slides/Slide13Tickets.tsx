      ...
      <div className="absolute inset-0 flex flex-col px-[8vw] pt-[8vh] pb-[7vh]">
        ...
        <div className="flex-1 flex gap-[3vw]">
          <div className="flex-1 bg-card rounded-[1.5vw] px-[3vw] py-[3vh] flex flex-col gap-[2vh]">
            <p className="font-body font-medium text-[2.6vw] text-accent uppercase tracking-widest">Kategorien</p>
          ...
          <div className="flex-1 bg-card rounded-[1.5vw] px-[3vw] py-[3vh] flex flex-col gap-[2vh]">
            <p className="font-body font-medium text-[2.6vw] text-accent uppercase tracking-widest">Prioritäten</p>
            <div className="h-[0.3vh] bg-primary opacity-10" />
            <div className="flex flex-col gap-[2vh]">
              <div className="flex items-center gap-[2vw]">
          ...
          <div className="flex-1 bg-primary rounded-[1.5vw] px-[3vw] py-[3vh] flex flex-col gap-[2vh]">
            <p className="font-body font-medium text-[2.6vw] text-white opacity-60 uppercase tracking-widest">Funktionen</p>
            <div className="h-[0.3vh] bg-white opacity-20" />
            <div className="flex flex-col gap-[2vh]">
              <div className="flex items-start gap-[1.5vw]">
                <div className="w-[0.8vw] h-[0.8vw] rounded-full bg-accent mt-[1.2vh] shrink-0" />
                <p className="font-body text-[3vw] text-white opacity-80">Kommentarthreads je Ticket</p>
              </div>
              <div className="flex items-start gap-[1.5vw]">
                <div className="w-[0.8vw] h-[0.8vw] rounded-full bg-accent mt-[1.2vh] shrink-0" />
                <p className="font-body text-[3vw] text-white opacity-80">Verknüpfung mit Verladung</p>
              </div>
              <div className="flex items-start gap-[1.5vw]">
                <div className="w-[0.8vw] h-[0.8vw] rounded-full bg-accent mt-[1.2vh] shrink-0" />
                <p className="font-body text-[3vw] text-white opacity-80">Status: Offen / Geschlossen</p>
              </div>
            </div>
          </div>
        </div>
