      ...
      <div className="absolute inset-0 flex flex-col px-[8vw] pt-[7vh] pb-[6vh]">
        ...
        <div className="flex-1 flex gap-[2.5vw]">
          <div className="flex-1 bg-primary rounded-[1.5vw] px-[3vw] py-[3vh] flex flex-col gap-[1.5vh] overflow-hidden">
            <p className="font-body font-medium text-[2.4vw] text-white opacity-60 uppercase tracking-widest">Typ 1</p>
            ...
            <div className="flex items-start gap-[1.5vw]">
              <div className="w-[0.7vw] h-[0.7vw] rounded-full bg-accent mt-[1vh] shrink-0" />
              <p className="font-body text-[2.8vw] text-white opacity-80">Eingang · Ausgang buchen</p>
            </div>
            <div className="flex items-start gap-[1.5vw]">
              <div className="w-[0.7vw] h-[0.7vw] rounded-full bg-accent mt-[1vh] shrink-0" />
          ...
          <div className="flex-1 bg-card rounded-[1.5vw] px-[3vw] py-[3vh] flex flex-col gap-[1.5vh] overflow-hidden">
            <p className="font-body font-medium text-[2.4vw] text-accent uppercase tracking-widest">Typ 2</p>
            ...
            <div className="flex items-start gap-[1.5vw]">
              <div className="w-[0.7vw] h-[0.7vw] rounded-full bg-accent mt-[1vh] shrink-0" />
              <p className="font-body text-[2.8vw] text-muted">Neutrale Buchungsart</p>
            </div>
            <div className="flex items-start gap-[1.5vw]">
              <div className="w-[0.7vw] h-[0.7vw] rounded-full bg-accent mt-[1vh] shrink-0" />
          ...
          <div className="flex-1 bg-card rounded-[1.5vw] px-[3vw] py-[3vh] flex flex-col gap-[1.5vh] overflow-hidden">
            <p className="font-body font-medium text-[2.4vw] text-accent uppercase tracking-widest">Typ 3</p>
